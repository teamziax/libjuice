...
// Immutable so concurrent STUN readers and writers need no initialization lock.
...
static uint32_t crc32_table(const uint8_t *p, size_t size, const uint32_t *table) {
